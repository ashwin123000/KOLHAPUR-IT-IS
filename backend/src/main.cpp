 ...
 * ✓ Project creation and browsinga
    ...
    void initializeSchema() {
        ...
        executeSQL(R"(
            CREATE TABLE IF NOT EXISTS projects (
                ...
                required_skills TEXT DEFAULT '', -- Comma-separated
...
// ONLY showing CHANGED PARTS + CLEAN MAIN
// Your DatabaseManager, Services, Utils = SAME (NO CHANGE)
...
int main() {
    ...
    ([](const crow::request& req) {
        try {
            return success(ProjectService::getAll(), req);
        } catch (const std::exception& e) {
